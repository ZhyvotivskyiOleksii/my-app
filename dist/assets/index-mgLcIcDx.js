 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yn extends qo{constructor(){super("facebook.com")}static credential(e){return qr._fromParams({providerId:Yn.PROVIDER_ID,signInMethod:Yn.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Yn.credentialFromTaggedObject(e)}static credentialFromError(e){return Yn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Yn.credential(e.oauthAccessToken)}catch{return null}}}Yn.FACEBOOK_SIGN_IN_METHOD="facebook.com";Yn.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jn extends qo{constructor(){super("github.com")}static credential(e){return qr._fromParams({providerId:Jn.PROVIDER_ID,signInMethod:Jn.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Jn.credentialFromTaggedObject(e)}static credentialFromError(e){return Jn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Jn.credential(e.oauthAccessToken)}catch{return null}}}Jn.GITHUB_SIGN_IN_METHOD="github.com";Jn.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e_(t,e,n=!1){if(Jt(t.app))return Promise.reject(kn(t));const r="signIn",i=await Z2(t,r,e),s=await Gr._fromIdTokenResponse(t,r,i);return n||await t._updateCurrentUser(s.user),s}async function vk(t,e){return e_(Ar(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function t_(t){const e=Ar(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function _k(t,e,n){const r=Ar(t);await jl(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",uk)}async function wk(t,e,n){if(Jt(t.app))return Promise.reject(kn(t));const r=Ar(t),o=await jl(r,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",mk).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&t_(t),u}),l=await Gr._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(l.user),l}function Ek(t,e,n){return Jt(t.app)?Promise.reject(kn(t)):vk(yt(t),os.credential(e,n)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&t_(t),r})}function Tk(t,e,n,r){return yt(t).onIdTokenChanged(e,n,r)}function Ik(t,e,n){return yt(t).beforeAuthStateChanged(e,n)}const zl="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wk="pendingRedirect",tl=new Map;class Hk extends c_{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=tl.get(this.auth._key());if(!e){try{const r=await Kk(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}tl.set(this.auth._key(),e)}return this.bypassAuthState||tl.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Kk(t,e){const n=Qk(e),r=Gk(t);if(!await r._isAvailable())return!1;const i=await r._get(n)==="true";return await r._remove(n),i}function qk(t,e){tl.set(t._key(),e)}function Gk(t){return In(t._redirectPersistence)}function Qk(t){return el(Wk,t.config.apiKey,t.name)}async function Yk(t,e,n=!1){if(Jt(t.app))return Promise.reject(kn(t));const r=Ar(t),i=Fk(r,e),o=await new Hk(r,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Br,d_;(function(){var t;/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(w,y){function _(){}_.prototype=y.prototype,w.D=y.prototype,w.prototype=new _,w.prototype.constructor=w,w.C=function(T,k,C){for(var A=Array(arguments.length-2),ht=2;ht<arguments.length;ht++)A[ht-2]=arguments[ht];return y.prototype[k].apply(T,A)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(w,y,_){_||(_=0);var T=Array(16);if(typeof y=="string")for(var k=0;16>k;++k)T[k]=y.charCodeAt(_++)|y.charCodeAt(_++)<<8|y.charCodeAt(_++)<<16|y.charCodeAt(_++)<<24;else for(k=0;16>k;++k)T[k]=y[_++]|y[_++]<<8|y[_++]<<16|y[_++]<<24;y=w.g[0],_=w.g[1],k=w.g[2];var C=w.g[3],A=y+(C^_&(k^C))+T[0]+3614090360&4294967295;y=_+(A<<7&4294967295|A>>>25),A=C+(k^y&(_^k))+T[1]+3905402710&4294967295,C=y+(A<<12&4294967295|A>>>20),A=k+(_^C&(y^_))+T[2]+606105819&4294967295,k=C+(A<<17&4294967295|A>>>15),A=_+(y^k&(C^y))+T[3]+3250441966&4294967295,_=k+(A<<22&4294967295|A>>>10),A=y+(C^_&(k^C))+T[4]+4118548399&4294967295,y=_+(A<<7&4294967295|A>>>25),A=C+(k^y&(_^k))+T[5]+1200080426&4294967295,C=y+(A<<12&4294967295|A>>>20),A=k+(_^C&(y^_))+T[6]+2821735955&4294967295,k=C+(A<<17&4294967295|A>>>15),A=_+(y^k&(C^y))+T[7]+4249261313&4294967295,_=k+(A<<22&4294967295|A>>>10),A=y+(C^_&(k^C))+T[8]+1770035416&4294967295,y=_+(A<<7&4294967295|A>>>25),A=C+(k^y&(_^k))+T[9]+2336552879&4294967295,C=y+(A<<12&4294967295|A>>>20),A=k+(_^C&(y^_))+T[10]+4294925233&4294967295,k=C+(A<<17&4294967295|A>>>15),A=_+(y^k&(C^y))+T[11]+2304563134&4294967295,_=k+(A<<22&4294967295|A>>>10),A=y+(C^_&(k^C))+T[12]+1804603682&4294967295,y=_+(A<<7&4294967295|A>>>25),A=C+(k^y&(_^k))+T[13]+4254626195&4294967295,C=y+(A<<12&4294967295|A>>>20),A=k+(_^C&(y^_))+T[14]+2792965006&4294967295,k=C+(A<<17&4294967295|A>>>15),A=_+(y^k&(C^y))+T[15]+1236535329&4294967295,_=k+(A<<22&4294967295|A>>>10),A=y+(k^C&(_^k))+T[1]+4129170786&4294967295,y=_+(A<<5&4294967295|A>>>27),A=C+(_^k&(y^_))+T[6]+3225465664&4294967295,C=y+(A<<9&4294967295|A>>>23),A=k+(y^_&(C^y))+T[11]+643717713&4294967295,k=C+(A<<14&4294967295|A>>>18),A=_+(C^y&(k^C))+T[0]+3921069994&4294967295,_=k+(A<<20&4294967295|A>>>12),A=y+(k^C&(_^k))+T[5]+3593408605&4294967295,y=_+(A<<5&4294967295|A>>>27),A=C+(_^k&(y^_))+T[10]+38016083&4294967295,C=y+(A<<9&4294967295|A>>>23),A=k+(y^_&(C^y))+T[15]+3634488961&4294967295,k=C+(A<<14&4294967295|A>>>18),A=_+(C^y&(k^C))+T[4]+3889429448&4294967295,_=k+(A<<20&4294967295|A>>>12),A=y+(k^C&(_^k))+T[9]+568446438&4294967295,y=_+(A<<5&4294967295|A>>>27),A=C+(_^k&(y^_))+T[14]+3275163606&4294967295,C=y+(A<<9&4294967295|A>>>23),A=k+(y^_&(C^y))+T[3]+4107603335&4294967295,k=C+(A<<14&4294967295|A>>>18),A=_+(C^y&(k^C))+T[8]+1163531501&4294967295,_=k+(A<<20&4294967295|A>>>12),A=y+(k^C&(_^k))+T[13]+2850285829&4294967295,y=_+(A<<5&4294967295|A>>>27),A=C+(_^k&(y^_))+T[2]+4243563512&4294967295,C=y+(A<<9&4294967295|A>>>23),A=k+(y^_&(C^y))+T[7]+1735328473&4294967295,k=C+(A<<14&4294967295|A>>>18),A=_+(C^y&(k^C))+T[12]+2368359562&4294967295,_=k+(A<<20&4294967295|A>>>12),A=y+(_^k^C)+T[5]+4294588738&4294967295,y=_+(A<<4&4294967295|A>>>28),A=C+(y^_^k)+T[8]+2272392833&4294967295,C=y+(A<<11&4294967295|A>>>21),A=k+(C^y^_)+T[11]+1839030562&4294967295,k=C+(A<<16&4294967295|A>>>16),A=_+(k^C^y)+T[14]+4259657740&4294967295,_=k+(A<<23&4294967295|A>>>9),A=y+(_^k^C)+T[1]+2763975236&4294967295,y=_+(A<<4&4294967295|A>>>28),A=C+(y^_^k)+T[4]+1272893353&4294967295,C=y+(A<<11&4294967295|A>>>21),A=k+(C^y^_)+T[7]+4139469664&4294967295,k=C+(A<<16&4294967295|A>>>16),A=_+(k^C^y)+T[10]+3200236656&4294967295,_=k+(A<<23&4294967295|A>>>9),A=y+(_^k^C)+T[13]+681279174&4294967295,y=_+(A<<4&4294967295|A>>>28),A=C+(y^_^k)+T[0]+3936430074&4294967295,C=y+(A<<11&4294967295|A>>>21),A=k+(C^y^_)+T[3]+3572445317&4294967295,k=C+(A<<16&4294967295|A>>>16),A=_+(k^C^y)+T[6]+76029189&4294967295,_=k+(A<<23&4294967295|A>>>9),A=y+(_^k^C)+T[9]+3654602809&4294967295,y=_+(A<<4&4294967295|A>>>28),A=C+(y^_^k)+T[12]+3873151461&4294967295,C=y+(A<<11&4294967295|A>>>21),A=k+(C^y^_)+T[15]+530742520&4294967295,k=C+(A<<16&4294967295|A>>>16),A=_+(k^C^y)+T[2]+3299628645&4294967295,_=k+(A<<23&4294967295|A>>>9),A=y+(k^(_|~C))+T[0]+4096336452&4294967295,y=_+(A<<6&4294967295|A>>>26),A=C+(_^(y|~k))+T[7]+1126891415&4294967295,C=y+(A<<10&4294967295|A>>>22),A=k+(y^(C|~_))+T[14]+2878612391&4294967295,k=C+(A<<15&4294967295|A>>>17),A=_+(C^(k|~y))+T[5]+4237533241&4294967295,_=k+(A<<21&4294967295|A>>>11),A=y+(k^(_|~C))+T[12]+1700485571&4294967295,y=_+(A<<6&4294967295|A>>>26),A=C+(_^(y|~k))+T[3]+2399980690&4294967295,C=y+(A<<10&4294967295|A>>>22),A=k+(y^(C|~_))+T[10]+4293915773&4294967295,k=C+(A<<15&4294967295|A>>>17),A=_+(C^(k|~y))+T[1]+2240044497&4294967295,_=k+(A<<21&4294967295|A>>>11),A=y+(k^(_|~C))+T[8]+1873313359&4294967295,y=_+(A<<6&4294967295|A>>>26),A=C+(_^(y|~k))+T[15]+4264355552&4294967295,C=y+(A<<10&4294967295|A>>>22),A=k+(y^(C|~_))+T[6]+2734768916&4294967295,k=C+(A<<15&4294967295|A>>>17),A=_+(C^(k|~y))+T[13]+1309151649&4294967295,_=k+(A<<21&4294967295|A>>>11),A=y+(k^(_|~C))+T[4]+4149444226&4294967295,y=_+(A<<6&4294967295|A>>>26),A=C+(_^(y|~k))+T[11]+3174756917&4294967295,C=y+(A<<10&4294967295|A>>>22),A=k+(y^(C|~_))+T[2]+718787259&4294967295,k=C+(A<<15&4294967295|A>>>17),A=_+(C^(k|~y))+T[9]+3951481745&4294967295,w.g[0]=w.g[0]+y&4294967295,w.g[1]=w.g[1]+(k+(A<<21&4294967295|A>>>11))&4294967295,w.g[2]=w.g[2]+k&4294967295,w.g[3]=w.g[3]+C&4294967295}r.prototype.u=function(w,y){y===void 0&&(y=w.length);for(var _=y-this.blockSize,T=this.B,k=this.h,C=0;C<y;){if(k==0)for(;C<=_;)i(this,w,C),C+=this.blockSize;if(typeof w=="string"){for(;C<y;)if(T[k++]=w.charCodeAt(C++),k==this.blockSize){i(this,T),k=0;break}}else for(;C<y;)if(T[k++]=w[C++],k==this.blockSize){i(this,T),k=0;break}}this.h=k,this.o+=y},r.prototype.v=function(){var w=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);w[0]=128;for(var y=1;y<w.length-8;++y)w[y]=0;var _=8*this.o;for(y=w.length-8;y<w.length;++y)w[y]=_&255,_/=256;for(this.u(w),w=Array(16),y=_=0;4>y;++y)for(var T=0;32>T;T+=8)w[_++]=this.g[y]>>>T&255;return w};function s(w,y){var _=l;return Object.prototype.hasOwnProperty.call(_,w)?_[w]:_[w]=y(w)}function o(w,y){this.h=y;for(var _=[],T=!0,k=w.length-1;0<=k;k--){var C=w[k]|0;T&&C==y||(_[k]=C,T=!1)}this.g=_}var l={};function u(w){return-128<=w&&128>w?s(w,function(y){return new o([y|0],0>y?-1:0)}):new o([w|0],0>w?-1:0)}function h(w){if(isNaN(w)||!isFinite(w))return p;if(0>w)return O(h(-w));for(var y=[],_=1,T=0;w>=_;T++)y[T]=w/_|0,_*=4294967296;return new o(y,0)}function f(w,y){if(w.length==0)throw Error("number format error: empty string");if(y=y||10,2>y||36<y)throw Error("radix out of range: "+y);if(w.charAt(0)=="-")return O(f(w.substring(1),y));if(0<=w.indexOf("-"))throw Error('number format error: interior "-" character');for(var _=h(Math.pow(y,8)),T=p,k=0;k<w.length;k+=8){var C=Math.min(8,w.length-k),A=parseInt(w.substring(k,k+C),y);8>C?(C=h(Math.pow(y,C)),T=T.j(C).add(h(A))):(T=T.j(_),T=T.add(h(A)))}return T}var p=u(0),m=u(1),I=u(16777216);t=o.prototype,t.m=function(){if(R(this))return-O(this).m();for(var w=0,y=1,_=0;_<this.g.length;_++){var T=this.i(_);w+=(0<=T?T:4294967296+T)*y,y*=4294967296}return w},t.toString=function(w){if(w=w||10,2>w||36<w)throw Error("radix out of range: "+w);if(P(this))return"0";if(R(this))return"-"+O(this).toString(w);for(var y=h(Math.pow(w,6)),_=this,T="";;){var k=D(_,y).g;_=E(_,k.j(y));var C=((0<_.g.length?_.g[0]:_.h)>>>0).toString(w);if(_=k,P(_))return C+T;for(;6>C.length;)C="0"+C;T=C+T}},t.i=function(w){return 0>w?0:w<this.g.length?this.g[w]:this.h};function P(w){if(w.h!=0)return!1;for(var y=0;y<w.g.length;y++)if(w.g[y]!=0)return!1;return!0}function R(w){return w.h==-1}t.l=function(w){return w=E(this,w),R(w)?-1:P(w)?0:1};function O(w){for(var y=w.g.length,_=[],T=0;T<y;T++)_[T]=~w.g[T];return new o(_,~w.h).add(m)}t.abs=function(){return R(this)?O(this):this},t.add=function(w){for(var y=Math.max(this.g.length,w.g.length),_=[],T=0,k=0;k<=y;k++){var C=T+(this.i(k)&65535)+(w.i(k)&65535),A=(C>>>16)+(this.i(k)>>>16)+(w.i(k)>>>16);T=A>>>16,C&=65535,A&=65535,_[k]=A<<16|C}return new o(_,_[_.length-1]&-2147483648?-1:0)};function E(w,y){return w.add(O(y))}t.j=function(w){if(P(this)||P(w))return p;if(R(this))return R(w)?O(this).j(O(w)):O(O(this).j(w));if(R(w))return O(this.j(O(w)));if(0>this.l(I)&&0>w.l(I))return h(this.m()*w.m());for(var y=this.g.length+w.g.length,_=[],T=0;T<2*y;T++)_[T]=0;for(T=0;T<this.g.length;T++)for(var k=0;k<w.g.length;k++){var C=this.i(T)>>>16,A=this.i(T)&65535,ht=w.i(k)>>>16,cn=w.i(k)&65535;_[2*T+2*k]+=A*cn,v(_,2*T+2*k),_[2*T+2*k+1]+=C*cn,v(_,2*T+2*k+1),_[2*T+2*k+1]+=A*ht,v(_,2*T+2*k+1),_[2*T+2*k+2]+=C*ht,v(_,2*T+2*k+2)}for(T=0;T<y;T++)_[T]=_[2*T+1]<<16|_[2*T];for(T=y;T<2*y;T++)_[T]=0;return new o(_,0)};function v(w,y){for(;(w[y]&65535)!=w[y];)w[y+1]+=w[y]>>>16,w[y]&=65535,y++}function S(w,y){this.g=w,this.h=y}function D(w,y){if(P(y))throw Error("division by zero");if(P(w))return new S(p,p);if(R(w))return y=D(O(w),y),new S(O(y.g),O(y.h));if(R(y))return y=D(w,O(y)),new S(O(y.g),y.h);if(30<w.g.length){if(R(w)||R(y))throw Error("slowDivide_ only works with positive integers.");for(var _=m,T=y;0>=T.l(w);)_=M(_),T=M(T);var k=j(_,1),C=j(T,1);for(T=j(T,2),_=j(_,2);!P(T);){var A=C.add(T);0>=A.l(w)&&(k=k.add(_),C=A),T=j(T,1),_=j(_,1)}return y=E(w,k.j(y)),new S(k,y)}for(k=p;0<=w.l(y);){for(_=Math.max(1,Math.floor(w.m()/y.m())),T=Math.ceil(Math.log(_)/Math.LN2),T=48>=T?1:Math.pow(2,T-48),C=h(_),A=C.j(y);R(A)||0<A.l(w);)_-=T,C=h(_),A=C.j(y);P(C)&&(C=m),k=k.add(C),w=E(w,A)}return new S(k,w)}t.A=function(w){return D(this,w).h},t.and=function(w){for(var y=Math.max(this.g.length,w.g.length),_=[],T=0;T<y;T++)_[T]=this.i(T)&w.i(T);return new o(_,this.h&w.h)},t.or=function(w){for(var y=Math.max(this.g.length,w.g.length),_=[],T=0;T<y;T++)_[T]=this.i(T)|w.i(T);return new o(_,this.h|w.h)},t.xor=function(w){for(var y=Math.max(this.g.length,w.g.length),_=[],T=0;T<y;T++)_[T]=this.i(T)^w.i(T);return new o(_,this.h^w.h)};function M(w){for(var y=w.g.length+1,_=[],T=0;T<y;T++)_[T]=w.i(T)<<1|w.i(T-1)>>>31;return new o(_,w.h)}function j(w,y){var _=y>>5;y%=32;for(var T=w.g.length-_,k=[],C=0;C<T;C++)k[C]=0<y?w.i(C+_)>>>y|w.i(C+_+1)<<32-y:w.i(C+_);return new o(k,w.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,d_=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,Br=o}).apply(typeof X0<"u"?X0:typeof self<"u"?self:typeof window<"u"?window:{});var La=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qr=new uf("@firebase/firestore");function bs(){return Qr.logLevel}function H(t,...e){if(Qr.logLevel<=ne.DEBUG){const n=e.map(Ef);Qr.debug(`Firestore (${as}): ${t}`,...n)}}function bn(t,...e){if(Qr.logLevel<=ne.ERROR){const n=e.map(Ef);Qr.error(`Firestore (${as}): ${t}`,...n)}}function qi(t,...e){if(Qr.logLevel<=ne.WARN){const n=e.map(Ef);Qr.warn(`Firestore (${as}): ${t}`,...n)}}function Ef(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $1=new Map;function W1(t,e){const n=Du(t);H1(n,e),o5(n,e)}function H1(t,e){const n=$1.get(t);if(n)for(const r of n)r(e)}function o5(t,e){const n=a5();n&&n.postMessage({key:t,fid:e}),l5()}let Ur=null;function a5(){return!Ur&&"BroadcastChannel"in self&&(Ur=new BroadcastChannel("[Firebase] FID Change"),Ur.onmessage=t=>{H1(t.data.key,t.data.fid)}),Ur}function l5(){$1.size===0&&Ur&&(Ur.close(),Ur=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const u5="firebase-installations-database",c5=1,Zr="firebase-installations-store";let Wc=null;function ep(){return Wc||(Wc=_u(u5,c5,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Zr)}}})),Wc}async function Jl(t,e){const n=Du(t),i=(await ep()).transaction(Zr,"readwrite"),s=i.objectStore(Zr),o=await s.get(n);return await s.put(e,n),await i.done,(!o||o.fid!==e.fid)&&W1(t,e.fid),e}async function K1(t){const e=Du(t),r=(await ep()).transaction(Zr,"readwrite");await r.objectStore(Zr).delete(e),await r.done}async function bu(t,e){const n=Du(t),i=(await ep()).transaction(Zr,"readwrite"),s=i.objectStore(Zr),o=await s.get(n),l=e(o);return l===void 0?await s.delete(n):await s.put(l,n),await i.done,l&&(!o||o.fid!==l.fid)&&W1(t,l.fid),l}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
